...
| [#78](https://github.com/Patrick-MY/YeLoli_Episode/issues/78) | 灵公主娃娃设定（PROP-014） | ✅ 已完成 |
...
| 06 | [#107](https://github.com/Patrick-MY/YeLoli_Episode/issues/107) | 妈妈说只能选两个·思思若有所思 | 商场 |
| 07 | [#108](https://github.com/Patrick-MY/YeLoli_Episode/issues/108) | 思思认真挑选·货架前来回踱步 | 商场 |
| 08 | [#109](https://github.com/Patrick-MY/YeLoli_Episode/issues/109) | 妈妈递玩具·思思双手接过 | 商场 |
| 09 | [#110](https://github.com/Patrick-MY/YeLoli_Episode/issues/110) | 思思举高玩具·满足陶醉 | 商场 |
| 10 | [#111](https://github.com/Patrick-MY/YeLoli_Episode/issues/111) | 妈妈摸思思头·笑脸转场 | 商场 |
| 11 | [#112](https://github.com/Patrick-MY/YeLoli_Episode/issues/112) | 思思冲入花园·阳光鲜花 | 花园 |
| 12 | [#113](https://github.com/Patrick-MY/YeLoli_Episode/issues/113) | 草地坐下·举起章鱼逆光剪影 | 花园 |
| 13 | [#114](https://github.com/Patrick-MY/YeLoli_Episode/issues/114) | 章鱼独角兽对话·思思配音 | 花园 |
| 14 | [#115](https://github.com/Patrick-MY/YeLoli_Episode/issues/115) | 虚拟想象空间·章鱼独角兽跳舞 | 花园 |
...
| 40 | [#141](https://github.com/Patrick-MY/YeLoli_Episode/issues/141) | 孔雀出场·镜中飞出 | 大召唤与茶会 |
...
| 52 | [#153](https://github.com/Patrick-MY/YeLoli_Episode/issues/153) | 儿歌前半·新玩具老朋友 | 小课堂与儿歌 |
| 53 | [#154](https://github.com/Patrick-MY/YeLoli_Episode/issues/154) | 儿歌后半·笑开怀·收尾 | 小课堂与儿歌 |

## 旧段 Issue（#82-#100，已关闭，由 53 段新版替代）

旧版 19 段结构已废弃，对应 Issue #82-#100 全部关闭。新版 53 段 Issue 见上方表格。

## 旧 Issue 对照（#2-#8）

| Issue | 状态 | 说明 |
|---|---|---|
| [#2](https://github.com/Patrick-MY/YeLoli_Episode/issues/2) 第 8 集全片初版反馈 | ✅ 已完成 | 一审反馈已收到并整理 |
| [#3](https://github.com/Patrick-MY/YeLoli_Episode/issues/3) 旧玩具单体资产 | ✅ 已关闭 | 由 [#80](https://github.com/Patrick-MY/YeLoli_Episode/issues/80) 覆盖 |
| [#5](https://github.com/Patrick-MY/YeLoli_Episode/issues/5) 逐镜头修改任务拆解 | ✅ 已完成 | 已拆为 59+26 个 cut |
| [#6](https://github.com/Patrick-MY/YeLoli_Episode/issues/6) 修改版镜头生成 | ✅ 已关闭 | 由 [#82](https://github.com/Patrick-MY/YeLoli_Episode/issues/82)-[#100](https://github.com/Patrick-MY/YeLoli_Episode/issues/100) 覆盖 |
| [#7](https://github.com/Patrick-MY/YeLoli_Episode/issues/7) 修改版剪辑合成 | 待开始 | 依赖 19 个段落返修完成 |
| [#8](https://github.com/Patrick-MY/YeLoli_Episode/issues/8) 一审待甲方确认问题同步 | ✅ 已完成 | 2026-05-24 甲方红字回复全部确认 |

## 已关闭 Issue（由新 Issue 覆盖）

| 原始 Issue | 替代 Issue | 说明 |
|---|---|---|
| [#72](https://github.com/Patrick-MY/YeLoli_Episode/issues/72) 商场环境设定 | [#101](https://github.com/Patrick-MY/YeLoli_Episode/issues/101) | SCN-001/002/003 合并为商场场景全局设定 |
| [#73](https://github.com/Patrick-MY/YeLoli_Episode/issues/73) 商场内部店铺设定 | [#101](https://github.com/Patrick-MY/YeLoli_Episode/issues/101) | 同上 |
| [#74](https://github.com/Patrick-MY/YeLoli_Episode/issues/74) 商场玩具替换设定 | [#101](https://github.com/Patrick-MY/YeLoli_Episode/issues/101) | 同上 |
...
2026-05-24 已通过 GitHub Personal Access Token (classic) 成功通过 API 批量创建 33 个 Issue。后续 Issue 维护可直接用 API 或 `gh` CLI 操作，不需要再依赖网页手动创建。
